...
# Get residuals
diversity_lm <- lm(log10(n_cliques) ~ effort,
                   data = diversity_df)
...
ggsave("results/modelling_out/viral_diversity/genome_data/permutation_test.PCA.png", width = 8, height = 5)
