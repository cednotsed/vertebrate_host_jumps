...
ref <- readDNAStringSet("results/dnds_out/family_gene_alignments/Wuhan-Hu-1-spike.fna")
spike_fna <- c(ref, spike_fna)

writeXStringSet(spike_fna, "results/dnds_out/family_gene_alignments/CoV2_spike.fna")
