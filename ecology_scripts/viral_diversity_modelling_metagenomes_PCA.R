...
# ggsave("results/modelling_out/confounders_linear_visualisation.png", width = 6, height = 4)
...
ggsave("results/modelling_out/viral_diversity/metagenome_data/permutation_test.PCA.png", width = 8, height = 5)
