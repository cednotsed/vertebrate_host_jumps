...
ggsave("results/modelling_out/viral_diversity/metagenome_data/confounders_linear_visualisation.png", width = 6, height = 4)
...
ggsave("results/modelling_out/viral_diversity/metagenome_data/permutation_test.png", width = 8, height = 5)
...
# 
# ggsave("results/modelling_out/viral_diversity/bootstrap_MAE.png", width = 8, height = 5)
